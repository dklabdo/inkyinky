...
function Hero() {
  return (
    <div className='w-full  '>
        ...
        <Link className="link hover:border-[#003C43] my-6 hover:border-[3px] hover:text-[#003C43] hover:bg-white  absolute -translate-x-2/4 -translate-y-2/4 text-[white] font-medium text-[16px] no-underline bg-[#003C43] rounded-xl px-8 py-3 left-2/4 top-[338px]" to="/Category">Shop Now</Link>
      </div>
      <h3 className=" text-center text-[48px] xs:text-[36px] pt-12 font-normal " >Latest Posters</h3>
